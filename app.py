...
# 这里我们构建 DOM 结构，严格对应 CSS 中的 #starry-section, .ufo, .planet, .meteor
html_structure = """
<div id="starry-section">
    ...
    <svg viewBox="0 0 640 512" class="icon-svg ufo">
        ...
        <path fill="#7dd3fc" opacity="0.4" d="M496 237.1s-51.8 50.9-176 50.9s-176-50.9-176-50.9C144 141.5 222.8 64 320 64s176 77.5 176 173.1z"/>
    </svg>
    
    <svg viewBox="0 0 512 512" class="icon-svg planet">
...
<div class="neon-container">
    ...
    <div class="cursive-instruction">Focus on your question... / 请在心中默念...</div>
</div>
"""
# --- 接 PART 1 代码 ---

# ... (在此处粘贴 Part 1 的 css_code 变量定义) ...

# 如果你将 Part 1 和 Part 2 放同一个文件，确保 css_code 在这里已经被定义
