...
try:
    ...
    GROQ_API_KEY = "gsk_..." # Replace with your key if needed locally
    # st.stop()
...
<style>
    ...
    /* 2. Force Streamlit Transparency */
    .stApp {
    ...
    /* 4. Star Animations (Converted from SCSS Loop) */
    .starry-section--background--stars {
        position: absolute;
        left: 0; top: 0;
        width: auto; height: auto;
        --stars-dimensions: 1.77; /* 1200 / 675 */
        animation: moveStars var(--animation-options);
    }

    /* Pre-calculated offsets from your SCSS mixin */
    #stars1 { --star-offset: 120vh; block-size: calc(100vh + 120vh); margin: calc(120vh * -0.5) 0 0 calc(((100vh + 120vh) * 1.77 - 100vw) * -0.5); }
    #stars2 { --star-offset: 180vh; block-size: calc(100vh + 180vh); margin: calc(180vh * -0.5) 0 0 calc(((100vh + 180vh) * 1.77 - 100vw) * -0.5); }
    #stars3 { --star-offset: 240vh; block-size: calc(100vh + 240vh); margin: calc(240vh * -0.5) 0 0 calc(((100vh + 240vh) * 1.77 - 100vw) * -0.5); }

    /* 5. Icons (UFO, Planet, Meteors) */
    .icon {
        position: absolute;
        z-index: 2;
        color: white; /* SVG fill fallback */
    }
    ...
    .icon.planet {
        ...
        height: 24vh;
        bottom: -9vh; /* adjusted for absolute positioning */
        left: 0;
    }
    ...
    .icon.meteor1 { right: -15vw; top: 10vh; }
    .icon.meteor2 { right: 15vw; top: 50vh; }
    .icon.meteor3 { right: 30vw; top: 20vh; }

    /* 6. Keyframe Animations */
    @keyframes moveStars {
        0% { transform: translateX(calc(((100vh + var(--star-offset)) * 1.77 - 100vw) * -0.5 * -1)); }
        100% { transform: translateX(calc(((100vh + var(--star-offset)) * 1.77 - 100vw) * -0.5)); }
    }
    ...
    @keyframes moveMeteor {
        0%, 60% { transform: translateX(50vw) translateY(-50vh); opacity: 1; }
        80%, 100% { transform: translateX(-50vw) translateY(50vh); opacity: 0; }
    }

    /* --- YOUR ORIGINAL DESIGN (NEON TITLE) --- */
    .neon-title {{
    ...
    /* Ensure chat messages are visible on top */
    .stChatMessage {
        position: relative;
        z-index: 5;
